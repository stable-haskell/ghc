...
/* standard application routines.  Generated by GHC.StgToCmm.AutoApply and
 * linked into each program, not into the RTS; see
 * Note [Linking the generic apply code] in GHC.Driver.Pipeline and
 * GHC.StgToCmm.ArgRep.
 */
RTS_RET(stg_ap_v);
RTS_RET(stg_ap_f);
