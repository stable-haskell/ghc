...
/* The four stg_stack_underflow_frame_* and stg_restore_cccs_* variants are
 * generated by GHC from rts/Jumps.h and linked into each program, not into
 * the RTS; see Note [Linking the generic apply code] in GHC.Driver.Pipeline. */
