...
type family GhcDiagnosticCode c = n | n -> c where
  ...
  GhcDiagnosticCode "TcRnTagToEnumMissingValArg"                    = Outdated 36495
  GhcDiagnosticCode "TcRnTagToEnumUnspecifiedResTy"                 = Outdated 08522
  GhcDiagnosticCode "TcRnTagToEnumResTyNotAnEnum"                   = Outdated 49356
  GhcDiagnosticCode "TcRnTagToEnumResTyTypeData"                    = Outdated 96189
